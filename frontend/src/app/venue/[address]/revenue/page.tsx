...
function HistoryItem({ label, amount }: { label: string; amount: string }) {
  return (
    <li className="flex items-center justify-between">
      <span className="text-[15px] text-text-secondary font-sans font-light">{label}</span>
      <span className="text-[15px] text-text-primary font-sans font-medium tracking-wide">{amount}</span>
    </li>
  );
}
