export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-[#2A2F3A] bg-[#181C23] text-[#A1A1AA]">
      {/* Upper */}
      <div className="w-full py-6 flex flex-col items-center">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-8 max-w-4xl w-full px-6">
          <p className="text-[13px] text-[#A1A1AA] font-sans">&copy; {currentYear} VenueFi</p>

          <nav className="flex flex-wrap items-center justify-center gap-5 sm:gap-8 text-[13px] text-[#A1A1AA] font-sans">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#71717A] hover:text-[#F3F4F6] transition-colors duration-200"
            >
            ...
            <a href="javascript:void(0)" className="text-[#71717A] hover:text-[#F3F4F6] transition-colors duration-200">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-center text-[13px] leading-[1.9] max-w-lg text-[#71717A] font-sans">
